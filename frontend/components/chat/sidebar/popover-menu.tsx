"use client";
import { LogOutIcon, Menu, Moon, UsersRoundIcon } from "lucide-react";
		...
		<Popover>
			...
			<PopoverContent className="w-64 p-0 ml-2">
				<div className="flex flex-col w-full">
					...
					<div className="flex w-full gap-4 items-center cursor-pointer p-4 border-b bg-bars-bg hover:bg-borders/75" onClick={() => router.push("/new")}>
